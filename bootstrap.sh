...
echo "{
  \"name\": \"@lark-sentry/screen-record\",
  \"version\": \"1.0.0\",
...
echo pnpm add @lark-sentry/constants --filter @lark-sentry/core
pnpm add @lark-sentry/constants --filter @lark-sentry/core
